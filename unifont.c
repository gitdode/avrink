...
const Character chars[] PROGMEM = {
    ...
    {0x00a1, INVERTED_EXCLAMATION_MARK},
    {0x00a2, CENT_SIGN},
    {0x00a3, POUND_SIGN},
    {0x00a4, CURRENCY_SIGN},
    {0x00a5, YEN_SIGN},
    {0x00a6, BROKEN_BAR},
    {0x00a7, SECTION_SIGN},
    {0x00a8, DIAERESIS},
    {0x00a9, COPYRIGHT_SIGN},
    {0x00aa, FEMININE_ORDINAL_INDICATOR},
    ...
    {0x00af, MACRON},
    {0x00b0, DEGREE_SIGN},
    {0x00b1, PLUS_MINUS_SIGN},
    {0x00b2, SUPERSCRIPT_TWO},
    {0x00b3, SUPERSCRIPT_THREE},
    {0x00b4, ACUTE_ACCENT},
    {0x00b5, MICRO_SIGN},
    {0x00b6, PILCROW_SIGN},
    {0x00b7, MIDDLE_DOT},
    {0x00b8, CEDILLA},
    {0x00b9, SUPERSCRIPT_ONE},
    {0x00ba, MASCULINE_ORDINAL_INDICATOR},
    {0x00bb, RIGHT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK},
    {0x00bc, VULGAR_FRACTION_ONE_QUARTER},
    {0x00bd, VULGAR_FRACTION_ONE_HALF},
    {0x00be, VULGAR_FRACTION_THREE_QUARTERS},
